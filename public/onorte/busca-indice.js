...
window.NORTE_INDICE = [
  ...
  { titulo: 'Lockup Aviação + Grupo', tipo: 'Arte', desc: 'As duas marcas no mesmo bloco — as seis artes de adesivo, para baixar.', tags: 'lockup adesivo frota caminhao caminhonete porta traseira veiculo vinil espelhado invertido branco aviacao grupo juntas duas marcas', href: 'Logotipos Oficiais.dc.html' },
  ...
  { titulo: 'Template de apresentação', tipo: 'Página', desc: 'Modelos de slide com instrução de uso.', tags: 'apresentacao slide slides deck powerpoint reuniao palestra', href: 'Template de Apresentação.dc.html' },
  { titulo: 'Apresentação (.pptx)', tipo: 'Arquivo', desc: 'Abre no PowerPoint; no Drive vira Google Slides.', tags: 'apresentacao pptx powerpoint slide baixar google slides drive', href: 'entregas/downloads/template-apresentacao-opp.pptx', download: 'Template de Apresentacao - Grupo Opp.pptx' },
  ...
  { titulo: 'Kit Express (.zip)', tipo: 'Arquivo', desc: 'Guia de aplicação, logos em alta e cores — 11,5 MB.', tags: 'kit zip baixar fornecedor grafica logo alta cores guia enviar', href: 'entregas/downloads/kit-express-marca-opp.zip', download: 'kit-express-marca-opp.zip' },
